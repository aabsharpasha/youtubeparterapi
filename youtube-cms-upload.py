...
# Required for most Partner API writes (assets, claims, references). Must match your CMS account.
CONTENT_OWNER_ID = os.environ.get(
    "YOUTUBE_CONTENT_OWNER_ID", "02huK19J4tiZapOAQkot0g"
).strip()
...
def create_asset_and_reference(partner, video_id):
    ...
    asset = partner.assets().insert(
        ...
        body={
            'metadata': {'title': 'Reference Asset'},
    ...
    partner.ownership().update(
        ...
        body={
            "general": {
                ...
                "ratio": 100,
                "type": "include",
                "territories": ["PH"] # Or ["PH"] for Philippines
            }
        }
    ).execute()
...
if __name__ == "__main__":
    ...
    result = create_asset_and_reference(partner, "fWBvVlGdMrM")
    print(result)
    print("Claim created successfully under Asset ID: ", result['assetId'])